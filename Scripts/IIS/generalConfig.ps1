...
New-NetIPAddress -InterfaceAlias Ethernet -IPAddress 192.168.22.2
Set-NetIPAddress -InterfaceAlias Ethernet -IPAddress 192.168.22.2 -PrefixLength 24 -DefaultGateway 192.168.22.4
